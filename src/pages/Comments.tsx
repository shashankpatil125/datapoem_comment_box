...
const delete_reply = (idx:number)=>{
  let _replies = allReplys.slice()
  ...
  return (
    <div className='w-full h-full bg-[#e8ecf8]'>
      <div className=' p-2 mx-auto w-full sm:w-6/12 md:w-8/12 lg:w-6/12'>
        ...
        {allReplys.map((comment,i)=>(<CommentBox comment={comment} onDelete={()=>delete_reply(i)}/> ))}

        <SendMsg onNewComment={e=>{
          const _comments = allReplys.slice()
          _comments.push(e)
          setallReplys(_comments)
        }}/>        
